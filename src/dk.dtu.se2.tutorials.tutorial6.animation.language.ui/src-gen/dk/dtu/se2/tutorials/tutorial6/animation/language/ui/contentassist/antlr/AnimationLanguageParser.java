...
* generated by Xtext
*/
package dk.dtu.se2.tutorials.tutorial6.animation.language.ui.contentassist.antlr;
...
public class AnimationLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected dk.dtu.se2.tutorials.tutorial6.animation.language.ui.contentassist.antlr.internal.InternalAnimationLanguageParser createParser() {
		dk.dtu.se2.tutorials.tutorial6.animation.language.ui.contentassist.antlr.internal.InternalAnimationLanguageParser result = new dk.dtu.se2.tutorials.tutorial6.animation.language.ui.contentassist.antlr.internal.InternalAnimationLanguageParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			dk.dtu.se2.tutorials.tutorial6.animation.language.ui.contentassist.antlr.internal.InternalAnimationLanguageParser typedParser = (dk.dtu.se2.tutorials.tutorial6.animation.language.ui.contentassist.antlr.internal.InternalAnimationLanguageParser) parser;
