		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_petrinet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_petrinet_feature", "_UI_Configuration_type"),
				 ConfigurationPackage.Literals.CONFIGURATION__PETRINET,
				 true,
				 false,
				 true,
				 null,
