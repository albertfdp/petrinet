...
/**
 * The Class InputPointLabelEditPart.
 *
 * @generated
 */
public class InputPointLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				GeometryVisualIDRegistry
						.getType(geometry.diagram.edit.parts.InputPointLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}

	/**
	 * Instantiates a new input point label edit part.
	 *
	 * @param view the view
	 * @generated
	 */
