...
/**
 * This is the item provider adapter for a {@link appearance.Appearance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AppearanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Appearance_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Appearance_id_feature", "_UI_Appearance_type"),
				 AppearancePackage.Literals.APPEARANCE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AppearancePackage.Literals.APPEARANCE__AOBJECTS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Appearance_type") + " " + appearance.getId();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AppearancePackage.Literals.APPEARANCE__AOBJECTS,
				 AppearanceFactory.eINSTANCE.createAObject()));
	}
