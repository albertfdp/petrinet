...
/**
 * This is the item provider adapter for a {@link appearance.AObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AObjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AObject_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AObject_label_feature", "_UI_AObject_type"),
				 AppearancePackage.Literals.AOBJECT__LABEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AObject)object).getLabel();
