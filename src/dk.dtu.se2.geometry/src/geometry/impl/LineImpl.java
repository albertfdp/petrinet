...
public class LineImpl extends GObjectImpl implements Line {
	/**
	 * The cached value of the '{@link #getBendPoint() <em>Bend Point</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getBendPoint()
	 * @generated
	...
	public BendPoint getBendPoint() {
		if (bendPoint != null && bendPoint.eIsProxy()) {
			InternalEObject oldBendPoint = (InternalEObject)bendPoint;
			bendPoint = (BendPoint)eResolveProxy(oldBendPoint);
			if (bendPoint != oldBendPoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeometryPackage.LINE__BEND_POINT, oldBendPoint, bendPoint));
			}
		}
		return bendPoint;
	}
	 ...
	 * @generated
	 */
	public BendPoint basicGetBendPoint() {
		return bendPoint;
	}
	...
	public void setBendPoint(BendPoint newBendPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeometryPackage.LINE__BEND_POINT, oldBendPoint, bendPoint));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeometryPackage.LINE__BEND_POINT:
				if (resolve) return getBendPoint();
				return basicGetBendPoint();
			case GeometryPackage.LINE__BEGIN:
