...
/**
 * This is the item provider adapter for a {@link dk.dtu.se2.animation.Hide} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HideItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hide_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hide_label_feature", "_UI_Hide_type"),
				 AnimationPackage.Literals.HIDE__LABEL,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Hide.class)) {
			case AnimationPackage.HIDE__LABEL:
