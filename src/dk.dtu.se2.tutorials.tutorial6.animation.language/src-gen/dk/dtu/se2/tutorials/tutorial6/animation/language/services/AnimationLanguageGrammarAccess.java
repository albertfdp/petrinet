...
* generated by Xtext
*/
package dk.dtu.se2.tutorials.tutorial6.animation.language.services;
...
public class AnimationLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("dk.dtu.se2.tutorials.tutorial6.animation.language.AnimationLanguage".equals(grammar.getName())) {
				return grammar;
			}
