 ...
 * <ul>
 *   <li>{@link geometry.impl.GeometryImpl#getGObjects <em>GObjects</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeometryImpl extends MinimalEObjectImpl.Container implements Geometry {
	...
	public EList<GObject> getGObjects() {
		if (gObjects == null) {
			gObjects = new EObjectContainmentEList<GObject>(GObject.class, this, GeometryPackage.GEOMETRY__GOBJECTS);
		}
		return gObjects;
	}
