 ...
 * <ul>
 *   <li>{@link dk.dtu.se2.petrinet.impl.GeometryLabelImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeometryLabelImpl extends LabelImpl implements GeometryLabel {
	...
	protected EClass eStaticClass() {
		return PetrinetPackage.Literals.GEOMETRY_LABEL;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.GEOMETRY_LABEL__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetPackage.GEOMETRY_LABEL__TEXT:
				return getText();
		}
