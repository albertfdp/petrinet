...
/**
 * This is the item provider adapter for a {@link geometry_model.Point} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_xLocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_xLocation_feature", "_UI_Point_type"),
				 Geometry_modelPackage.Literals.POINT__XLOCATION,
				 true,
				 false,
				 false,
	...
	protected void addYLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_yLocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_yLocation_feature", "_UI_Point_type"),
				 Geometry_modelPackage.Literals.POINT__YLOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Point.class)) {
			case Geometry_modelPackage.POINT__XLOCATION:
			case Geometry_modelPackage.POINT__YLOCATION:
