 ...
 * <ul>
 *   <li>{@link geometry_model.impl.PointImpl#getXLocation <em>XLocation</em>}</li>
 *   <li>{@link geometry_model.impl.PointImpl#getYLocation <em>YLocation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointImpl extends GObjectImpl implements Point {
	...
	protected EClass eStaticClass() {
		return Geometry_modelPackage.Literals.POINT;
	}
	...
	public void setXLocation(int newXLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Geometry_modelPackage.POINT__XLOCATION, oldXLocation, xLocation));
	}
	...
	public void setYLocation(int newYLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Geometry_modelPackage.POINT__YLOCATION, oldYLocation, yLocation));
	}
