 ...
 * <ul>
 *   <li>{@link geometry_model.impl.ConnectorImpl#getOut <em>Out</em>}</li>
 *   <li>{@link geometry_model.impl.ConnectorImpl#getIn <em>In</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends PointImpl implements Connector {
	...
	protected EClass eStaticClass() {
		return Geometry_modelPackage.Literals.CONNECTOR;
	}
	...
	public EList<Line> getOut() {
		if (out == null) {
			out = new EObjectWithInverseResolvingEList<Line>(Line.class, this, Geometry_modelPackage.CONNECTOR__OUT, Geometry_modelPackage.LINE__BEGIN);
		}
		return out;
	}
	...
	public EList<Line> getIn() {
		if (in == null) {
			in = new EObjectWithInverseResolvingEList<Line>(Line.class, this, Geometry_modelPackage.CONNECTOR__IN, Geometry_modelPackage.LINE__END);
		}
		return in;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Geometry_modelPackage.CONNECTOR__OUT:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getOut()).basicAdd(otherEnd, msgs);
			case Geometry_modelPackage.CONNECTOR__IN:
