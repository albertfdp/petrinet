...
public class PetrinetNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case PetrinetEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Diagram?http://petrinet/1.0?Petrinet", PetrinetElementTypes.Petrinet_1000); //$NON-NLS-1$
		case PlaceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://petrinet/1.0?Place", PetrinetElementTypes.Place_2001); //$NON-NLS-1$
		case TransitionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://petrinet/1.0?Transition", PetrinetElementTypes.Transition_2002); //$NON-NLS-1$
		case TokenEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://petrinet/1.0?Token", PetrinetElementTypes.Token_3001); //$NON-NLS-1$
		case ArcEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://petrinet/1.0?Arc", PetrinetElementTypes.Arc_4001); //$NON-NLS-1$
		}
