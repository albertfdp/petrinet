...
public class PetrinetDiagramUpdater {
	...
	public static List<PetrinetNodeDescriptor> getPetrinet_1000SemanticChildren(
		...
		for (Iterator<?> it = modelElement.getObjects().iterator(); it
				.hasNext();) {
			PObject childElement = (PObject) it.next();
	 ...
	 * @generated
	 */
	public static List<PetrinetNodeDescriptor> getPlace_2001SemanticChildren(
			View view) {
		if (!view.isSetElement()) {
			return Collections.emptyList();
		}
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getPlace_2001ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getTransition_2002ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getPlace_2001IncomingLinks(
			View view) {
		Place modelElement = (Place) view.getElement();
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getTransition_2002IncomingLinks(
			View view) {
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getPlace_2001OutgoingLinks(
			View view) {
		Place modelElement = (Place) view.getElement();
		LinkedList<PetrinetLinkDescriptor> result = new LinkedList<PetrinetLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getTransition_2002OutgoingLinks(
			View view) {
		Transition modelElement = (Transition) view.getElement();
		LinkedList<PetrinetLinkDescriptor> result = new LinkedList<PetrinetLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Arc_4001(modelElement));
	...
	private static Collection<PetrinetLinkDescriptor> getContainedTypeModelFacetLinks_Arc_4001(
			Petrinet container) {
		LinkedList<PetrinetLinkDescriptor> result = new LinkedList<PetrinetLinkDescriptor>();
		for (Iterator<?> links = container.getObjects().iterator(); links
				.hasNext();) {
