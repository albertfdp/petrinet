package dk.dtu.imm.se2.filetypeview.views;
...
public class FileTypeView extends ViewPart implements ISelectionListener {
	 ...
	 */
	public static final String ID = "dk.dtu.imm.se2.filetypeview.views.FileTypeView";
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				FileTypeView.this.fillContextMenu(manager);
			}
		});
	...
	public void selectionChanged(IWorkbenchPart part, ISelection selection) {
		...
		String[] extensions = this.getFileExtension(selection);
