 ...
 * <ul>
 *   <li>{@link dk.dtu.se2.petrinet.impl.AppearanceLabelImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AppearanceLabelImpl extends LabelImpl implements AppearanceLabel {
	...
	protected EClass eStaticClass() {
		return PetrinetPackage.Literals.APPEARANCE_LABEL;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.APPEARANCE_LABEL__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetPackage.APPEARANCE_LABEL__TEXT:
				return getText();
		}
