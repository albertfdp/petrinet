 ...
 * generated by Xtext
 */
package dk.dtu.se2.tutorials.tutorial6.animationTest.language.formatting;
...
public class AnimationLanguageFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private AnimationLanguageGrammarAccess _animationLanguageGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._animationLanguageGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._animationLanguageGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._animationLanguageGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._animationLanguageGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._animationLanguageGrammarAccess.getML_COMMENTRule();
