...
* generated by Xtext
*/
package dk.dtu.se2.tutorials.tutorial6.animationTest.language.parser.antlr;
...
public class AnimationLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected dk.dtu.se2.tutorials.tutorial6.animationTest.language.parser.antlr.internal.InternalAnimationLanguageParser createParser(XtextTokenStream stream) {
		return new dk.dtu.se2.tutorials.tutorial6.animationTest.language.parser.antlr.internal.InternalAnimationLanguageParser(stream, getGrammarAccess());
	}
