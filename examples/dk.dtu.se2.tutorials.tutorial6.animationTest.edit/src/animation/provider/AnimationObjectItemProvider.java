...
/**
 * This is the item provider adapter for a {@link animation.AnimationObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnimationObjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnimationObject_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnimationObject_label_feature", "_UI_AnimationObject_type"),
				 AnimationPackage.Literals.ANIMATION_OBJECT__LABEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AnimationObject)object).getLabel();
