...
import geometry2nd.diagram.edit.policies.BendPointItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BendPointEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public BendPointEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BendPointItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new BendPointFigure();
	}

	/**
	 * @generated
	 */
	public BendPointFigure getPrimaryShape() {
		return (BendPointFigure) primaryShape;
	}
