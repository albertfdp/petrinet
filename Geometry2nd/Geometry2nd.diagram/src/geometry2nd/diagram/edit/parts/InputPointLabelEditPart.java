...
import geometry2nd.diagram.edit.policies.Geometry2ndTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InputPointLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InputPointLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new Geometry2ndTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return Geometry2ndElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Geometry2ndParserProvider
					.getParser(
							Geometry2ndElementTypes.InputPoint_2001,
							getParserElement(),
							Geometry2ndVisualIDRegistry
									.getType(geometry2nd.diagram.edit.parts.InputPointLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					Geometry2ndEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
