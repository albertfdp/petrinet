 ...
 * @generated
 */
public class ConnectorInReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectorInReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return Geometry2ndBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConnectorIn_4008(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return Geometry2ndBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConnectorIn_4008(getOldSource(), getNewTarget());
	}
