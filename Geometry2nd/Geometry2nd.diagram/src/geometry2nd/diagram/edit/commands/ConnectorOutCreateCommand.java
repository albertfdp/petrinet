 ...
 * @generated
 */
public class ConnectorOutCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectorOutCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Line) {
			return false;
		}
		if (getSource() == null) {
		...
		return Geometry2ndBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConnectorOut_4009(getSource(), getTarget());
	}
