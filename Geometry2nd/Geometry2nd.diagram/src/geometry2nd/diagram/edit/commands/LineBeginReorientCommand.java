 ...
 * @generated
 */
public class LineBeginReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LineBeginReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return Geometry2ndBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLineBegin_4007(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return Geometry2ndBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLineBegin_4007(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setBegin(null);
		getNewSource().setBegin(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setBegin(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
