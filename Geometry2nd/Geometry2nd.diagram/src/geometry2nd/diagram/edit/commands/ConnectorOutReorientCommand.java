 ...
 * @generated
 */
public class ConnectorOutReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConnectorOutReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Line && newEnd instanceof Connector)) {
			return false;
		}
		return Geometry2ndBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConnectorOut_4009(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof Line && newEnd instanceof Line)) {
			return false;
		}
		return Geometry2ndBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConnectorOut_4009(getOldSource(), getNewTarget());
	}
