...
import geometry2nd.diagram.part.Geometry2ndDiagramEditor;
 ...
 * @generated
 */
public class Geometry2ndNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof Geometry2ndNavigatorItem) {
					selectedElement = ((Geometry2ndNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (GeometryEditPart.MODEL_ID
							.equals(Geometry2ndVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, Geometry2ndDiagramEditor.ID);
