 ...
 * @generated
 */
public class Geometry2ndDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Geometry2ndDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Geometry2ndDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Geometry2ndDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Geometry2ndDomainNavigatorItem(
