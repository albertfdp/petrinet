 ...
 * @generated
 */
public class Geometry2ndInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new Geometry2ndNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				GeometryEditPart.MODEL_ID));
		Geometry2ndDiagramEditorUtil.runWizard(getShell(), wizard,
