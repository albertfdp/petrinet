 ...
 * @generated
 */
public class Geometry2ndViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = Geometry2ndVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = Geometry2ndVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!Geometry2ndElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != Geometry2ndVisualIDRegistry
				...
				if (!GeometryEditPart.MODEL_ID
						.equals(Geometry2ndVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = Geometry2ndVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != Geometry2ndVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = Geometry2ndVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ConnectorEditPart.VISUAL_ID:
		...
		case InputPointEditPart.VISUAL_ID:
			return createInputPoint_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case BendPointEditPart.VISUAL_ID:
			return createBendPoint_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (Geometry2ndVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ConnectorInEditPart.VISUAL_ID:
			return createConnectorIn_4008(containerView, index, persisted,
					preferencesHint);
		case LineEndEditPart.VISUAL_ID:
			return createLineEnd_4006(containerView, index, persisted,
					preferencesHint);
		case ConnectorOutEditPart.VISUAL_ID:
			return createConnectorOut_4009(containerView, index, persisted,
					preferencesHint);
		case LineBeginEditPart.VISUAL_ID:
			return createLineBegin_4007(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createInputPoint_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Geometry2ndVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createBendPoint_2002(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Edge createConnectorIn_4008(View containerView, int index,
		...
		edge.setType(Geometry2ndVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createLineEnd_4006(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createConnectorOut_4009(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createLineBegin_4007(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
