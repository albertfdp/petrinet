...
/**
 * This is the item provider adapter for a {@link geometry2nd.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Geometry2ndPackage.Literals.CONNECTOR__OUT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Geometry2ndPackage.Literals.CONNECTOR__IN,
				 true,
				 false,
				 true,
				 null,
